...
🧺 Утюг
    `,
    images: [
      { type: 'photo', media: 'images/rooms/deluxe/Deluxe1.jpeg' },
  ...
  lg_js: { 
    ...
    description: `<b>Junior Suite</b> - просторные однокомнатные апартаменты с полноразмерной кухней и балконом. 
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/lg_js/lg_js1.jpeg' },
  ...
  studio: { 
    ...
    description: `<b>Studio</b> - комфортная студия с продуманной планировкой, большим количеством мест для хранения и оборудованной кухней для двух гостей. Панорамные окна наполняют номер естественным светом, а теплыми вечерами можно отдыхать на балконе.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/studio/studio1.jpeg' },
  ...
  studio_dzh: { 
    ...
    description: `<b>Studio Jacuzzi</b> - эксклюзивная студия с отдельной спальней, полностью оборудованной кухней-гостиной и ванной комнатой. На собственной просторной террасе с зоной джакузи вы сможете расслабиться и насладиться отдыхом под открытым небом.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/studio_dzh/studio_dzh1.jpeg' },
  ...
  lg_js_dzh: { 
    ...
    description: `<b>La Green Junior Suite Jacuzzi </b> - просторные апартаменты с одной спальней и гостиной, где можно отдохнуть на удобном раскладывающемся диване и насладиться обеденной зоной. Для вашего комфорта в номере есть балкон и собственная терраса с джакузи, где можно расслабиться в течение дня.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/lg_js_dzh/lg_js_dzh1.jpeg' },
  ...
  lg_js_pl: { 
    ...
    description: `<b>La Green Junior Suite Pool Access </b> - специальный номер на первом этаже с прямым доступом к главному бассейну комплекса через собственную террасу. В апартаментах есть одна спальня, гостиная с оборудованной кухней и ванная комната, чтобы обеспечить вам максимальный комфорт.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/lg_js_pl/lg_js_pl1.jpeg' },
  ...
  lg_js_2br: { 
    ...
    description: `<b>La Green Junior Suite 2 Bedrooms </b> - Просторный семейный номер с террасой и большой гостиной зоной, объединяющей столовую и кухню в одном жилом пространстве. Номер включает две изолированные спальни, два санузла с ванной и душевой кабиной для вашего удобства.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/lg_js_2br/lg_js_2br1.jpeg' },
  ...
  lg_js_2br_dzh: { 
    ...
    description: `<b>La Green Junior Suite 2 Bedrooms Jacuzzi</b> - просторный люкс с двумя спальнями и собственной террасой с зоной джакузи. Удобная гостиная с кухней и обеденной зоной, две ванные комнаты и изолированные спальни сделают отдых комфортным для всей семьи.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/lg_js_2br_dzh/lg_js_2br_dzh1.jpeg' },
  ...
  lg_js_2br_pl: { 
    ...
    description: `<b>La Green Junior Suite 2 Bedrooms Pool Access </b> - cемейный номер с двумя изолированными спальнями и гостиной, совмещенной с полноразмерной кухней-столовой. Номер расположен на первом этаже и предоставляет эксклюзивный доступ к главному бассейну через собственную террасу.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/lg_js_2br_pl/lg_js_2br_pl1.jpeg' },
  ...
  duplex_2br_pl: { 
    ...
    description: `<b>Duplex Suite </b> - роскошные двухэтажные апартаменты площадью 109 м². На первом этаже расположены просторная кухня-гостиная, ванная комната и выход к главному бассейну. На втором этаже находятся две спальни и общая ванная комната для вашего комфорта.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/duplex_2br_pool/duplex_2br_pool1.jpeg' },
  ...
  lg_suite_3br: {
    ...
    description: `<b>La Green Suite 3 Bedrooms </b> - просторные апартаменты с тремя спальнями, тремя санузлами и большим количеством удобств для комфортного отдыха. Идеально подходит для семейного проживания или групп.
...
`,
    images: [
      { type: 'photo', media: 'images/rooms/lg_suite_3br/lg_suite_3br1.jpeg' },
