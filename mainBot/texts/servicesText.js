...
const servicesDescription = {
  transportation: {
    ...
    isActive: true,
    description: `🚗 Хотите заказать трансфер в аэропорт?
...
📩 После получения информации мы свяжемся с вами для подтверждения трансфера!
  ...
  wake_up_call: {
    ...
    img: 'images/rooms/lg_suite_3br/lg_suite_3br9.jpeg',
    isActive: true,
    description: `😴 Позаботимся о вашем пробуждении!
...
Мы подтвердим заказ и позаботимся, чтобы вы не проспали важное. 💬🔔`,
  ...
  breakfastBox: {
    ...
    img: 'images/rooms/lg_suite_3br/lg_suite_3br9.jpeg',
    isActive: true,
    description: `🍱 Ранний выезд — не повод уезжать голодным!
...
📬 Подтверждение времени отправим в ответ.`,
  ...
  luggageDown: {
    ...
    img: 'images/rooms/lg_suite_3br/lg_suite_3br9.jpeg',
    isActive: true,
    description: `🧳 Нужна помощь с багажом?
